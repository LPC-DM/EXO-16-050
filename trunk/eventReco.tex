...
The ``soft-drop'' jet grooming algorithm~\cite{msd} is applied to the jets to remove the wide-angle ISR and soft radiation emerging from the underlying event. We refer to the groomed mass of the CA15 jet as $m_\text{SD}$. 
