...
\abstract{A search for dark matter produced in association with a Higgs boson that decays into a pair of bottom quarks is performed in
 proton-proton collisions at a center-of-mass energy $\sqrt{s}=13~\mathrm{TeV}$
 collected with the CMS detector at the LHC. The analyzed data sample corresponds to an integrated luminosity of $35.9~\mathrm{fb}^{-1}$. 
...
pdftitle={Search for associated production of dark matter with a Higgs boson that decays to a pair of bottom quarks},%
pdfsubject={CMS},%
