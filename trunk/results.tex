...
(150)\GeV. In all 2HDM+a interpretations, a DM mass of $m_\chi=10\GeV$ is assumed. For the Baryonic Z' model, we exclude Z' masses up to 1.6\TeV for a DM mass of 1\GeV, and DM masses up to 475\GeV for a Z' mass of 1.1\TeV. The reinterpretation of the results for the Baryonic Z' model in terms of SI nucleon scatterin cross section results in a higher sensitivity of the search presented compared to direct detection experiments for $m_\chi<5\GeV$. 
