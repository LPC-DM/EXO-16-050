...
\begin{table}\footnotesize
  \begin{center}
    \caption{Sources of systematic uncertainties, along with the type (rate/shape)
...
A shape uncertainty due to bin-by-bin statistical uncertainties on the transfer factors is considered for all the processes predicted from data in CRs.
